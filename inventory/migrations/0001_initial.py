    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movement_type', models.CharField(choices=[('IN', 'Incoming'), ('OUT', 'Outgoing'), ('RETURN', 'Return'), ('ADJUST', 'Adjustment')], max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='hrm.departmentuser')),
