...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(blank=True, choices=[('front_desk', 'front_desk'), ('pos_staff', 'pos_staff'), ('hr_staff', 'hr_ataff'), ('manager', 'manager'), ('waiter', 'waiter'), ('supervisor', 'supervisor'), ('potter', 'potter'), ('accountant', 'accountant'), ('store_keeper', 'store_keeper'), ('security', 'security')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('shift_type', models.CharField(blank=True, choices=[('Morning', 'Morning'), ('afternoon', 'Afternoon'), ('night', 'Night'), ('24_hours', '24_hours'), ('12_hours', '12_hours')], max_length=50, null=True)),
